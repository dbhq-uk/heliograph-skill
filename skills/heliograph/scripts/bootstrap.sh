...
#
#  Copies run.sh, agent.sh, caprun.sh, caplib.sh, lib/, steps/, agent/,
#  ops-logs/ and TASK.md into <target-dir>, and installs the toolkit's
#  gitignore as <target-dir>/.gitignore.
#
